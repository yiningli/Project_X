function varargout = coatingTransmissionVsWavelength(varargin)
% COATINGTRANSMISSIONVSWAVELENGTH MATLAB code for coatingTransmissionVsWavelength.fig
%      COATINGTRANSMISSIONVSWAVELENGTH, by itself, creates a new COATINGTRANSMISSIONVSWAVELENGTH or raises the existing
%      singleton*.
%
%      H = COATINGTRANSMISSIONVSWAVELENGTH returns the handle to a new COATINGTRANSMISSIONVSWAVELENGTH or the handle to
%      the existing singleton*.
%
%      COATINGTRANSMISSIONVSWAVELENGTH('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in COATINGTRANSMISSIONVSWAVELENGTH.M with the given input arguments.
%
%      COATINGTRANSMISSIONVSWAVELENGTH('Property','Value',...) creates a new COATINGTRANSMISSIONVSWAVELENGTH or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before coatingTransmissionVsWavelength_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to coatingTransmissionVsWavelength_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help coatingTransmissionVsWavelength

% Last Modified by GUIDE v2.5 26-Oct-2013 20:59:53

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @coatingTransmissionVsWavelength_OpeningFcn, ...
                   'gui_OutputFcn',  @coatingTransmissionVsWavelength_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before coatingTransmissionVsWavelength is made visible.
function coatingTransmissionVsWavelength_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to coatingTransmissionVsWavelength (see VARARGIN)

% Choose default command line output for coatingTransmissionVsWavelength
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes coatingTransmissionVsWavelength wait for user response (see UIRESUME)
% uiwait(handles.coatingTransmissionVsWavelength);
...
function varargout = coatingTransmissionVsWavelength_OutputFcn(hObject, eventdata, handles) 
...
currentOpticalSystem1.SurfaceArray(surfIndex).Coating.plotCoatingTransmissionVsWavelength(handles.axesRefVsAng,wavLen,...
