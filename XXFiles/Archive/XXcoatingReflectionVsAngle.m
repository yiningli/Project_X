function varargout = coatingReflectionVsAngle(varargin)
% COATINGREFLECTIONVSANGLE MATLAB code for coatingReflectionVsAngle.fig
%      COATINGREFLECTIONVSANGLE, by itself, creates a new COATINGREFLECTIONVSANGLE or raises the existing
%      singleton*.
%
%      H = COATINGREFLECTIONVSANGLE returns the handle to a new COATINGREFLECTIONVSANGLE or the handle to
%      the existing singleton*.
%
%      COATINGREFLECTIONVSANGLE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in COATINGREFLECTIONVSANGLE.M with the given input arguments.
%
%      COATINGREFLECTIONVSANGLE('Property','Value',...) creates a new COATINGREFLECTIONVSANGLE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before coatingReflectionVsAngle_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to coatingReflectionVsAngle_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help coatingReflectionVsAngle

% Last Modified by GUIDE v2.5 26-Oct-2013 20:34:26

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @coatingReflectionVsAngle_OpeningFcn, ...
                   'gui_OutputFcn',  @coatingReflectionVsAngle_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before coatingReflectionVsAngle is made visible.
function coatingReflectionVsAngle_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to coatingReflectionVsAngle (see VARARGIN)

% Choose default command line output for coatingReflectionVsAngle
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes coatingReflectionVsAngle wait for user response (see UIRESUME)
% uiwait(handles.coatingReflectionVsAngle);
...
function varargout = coatingReflectionVsAngle_OutputFcn(hObject, eventdata, handles) 
...
currentOpticalSystem1.SurfaceArray(surfIndex).Coating.plotCoatingReflectionVsAngle(handles.axesRefVsAng,wavLen,...
