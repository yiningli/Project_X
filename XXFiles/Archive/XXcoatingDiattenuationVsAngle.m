function varargout = coatingDiattenuationVsAngle(varargin)
% COATINGDIATTENUATIONVSANGLE MATLAB code for coatingDiattenuationVsAngle.fig
%      COATINGDIATTENUATIONVSANGLE, by itself, creates a new COATINGDIATTENUATIONVSANGLE or raises the existing
%      singleton*.
%
%      H = COATINGDIATTENUATIONVSANGLE returns the handle to a new COATINGDIATTENUATIONVSANGLE or the handle to
%      the existing singleton*.
%
%      COATINGDIATTENUATIONVSANGLE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function namefd CALLBACK in COATINGDIATTENUATIONVSANGLE.M with the given input arguments.
%
%      COATINGDIATTENUATIONVSANGLE('Property','Value',...) creates a new COATINGDIATTENUATIONVSANGLE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before coatingDiattenuationVsAngle_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to coatingDiattenuationVsAngle_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help coatingDiattenuationVsAngle

% Last Modified by GUIDE v2.5 26-Oct-2013 15:21:19

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @coatingDiattenuationVsAngle_OpeningFcn, ...
                   'gui_OutputFcn',  @coatingDiattenuationVsAngle_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before coatingDiattenuationVsAngle is made visible.
function coatingDiattenuationVsAngle_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to coatingDiattenuationVsAngle (see VARARGIN)

% Choose default command line output for coatingDiattenuationVsAngle
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes coatingDiattenuationVsAngle wait for user response (see UIRESUME)
% uiwait(handles.coatingDiattenuationVsAngle);
...
function varargout = coatingDiattenuationVsAngle_OutputFcn(hObject, eventdata, handles) 
...
currentOpticalSystem1.SurfaceArray(surfIndex).Coating.plotCoatingDiattenuationVsAngle(handles.axesRefVsAng,wavLen,...
