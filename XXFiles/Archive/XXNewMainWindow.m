function varargout = NewMainWindow(varargin)
% NEWMAINWINDOW MATLAB code for NewMainWindow.fig
%      NEWMAINWINDOW, by itself, creates a new NEWMAINWINDOW or raises the existing
%      singleton*.
%
%      H = NEWMAINWINDOW returns the handle to a new NEWMAINWINDOW or the handle to
%      the existing singleton*.
%
%      NEWMAINWINDOW('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in NEWMAINWINDOW.M with the given input arguments.
%
%      NEWMAINWINDOW('Property','Value',...) creates a new NEWMAINWINDOW or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before NewMainWindow_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to NewMainWindow_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help NewMainWindow

% Last Modified by GUIDE v2.5 21-Feb-2014 10:55:05
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @NewMainWindow_OpeningFcn, ...
                   'gui_OutputFcn',  @NewMainWindow_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function NewMainWindow_CreateFcn(hObject, eventdata, handles)
% hObject    handle to NewMainWindow (see GCBO)
...
% --- Executes just before NewMainWindow is made visible.
function NewMainWindow_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to NewMainWindow (see VARARGIN)

% Choose default command line output for NewMainWindow
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);
% UIWAIT makes NewMainWindow wait for user response (see UIRESUME)
% uiwait(handles.NewMainWindow);
...
function varargout = NewMainWindow_OutputFcn(hObject, eventdata, handles) 
...
% --- Executes when user attempts to close NewMainWindow.
function NewMainWindow_CloseRequestFcn(hObject, eventdata, handles)
% hObject    handle to NewMainWindow (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes when NewMainWindow is resized.
function NewMainWindow_ResizeFcn(hObject, eventdata, handles)
% hObject    handle to NewMainWindow (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
InitializeOpenedWindowsPanel

InitializeSurfaceEditorPanels
% set(findobj('Tag','panelStandardData'),'Parent',handles,'Visible','on')
