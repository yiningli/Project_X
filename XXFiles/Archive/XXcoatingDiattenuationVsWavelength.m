function varargout = coatingDiattenuationVsWavelength(varargin)
% COATINGDIATTENUATIONVSWAVELENGTH MATLAB code for coatingDiattenuationVsWavelength.fig
%      COATINGDIATTENUATIONVSWAVELENGTH, by itself, creates a new COATINGDIATTENUATIONVSWAVELENGTH or raises the existing
%      singleton*.
%
%      H = COATINGDIATTENUATIONVSWAVELENGTH returns the handle to a new COATINGDIATTENUATIONVSWAVELENGTH or the handle to
%      the existing singleton*.
%
%      COATINGDIATTENUATIONVSWAVELENGTH('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in COATINGDIATTENUATIONVSWAVELENGTH.M with the given input arguments.
%
%      COATINGDIATTENUATIONVSWAVELENGTH('Property','Value',...) creates a new COATINGDIATTENUATIONVSWAVELENGTH or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before coatingDiattenuationVsWavelength_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to coatingDiattenuationVsWavelength_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help coatingDiattenuationVsWavelength

% Last Modified by GUIDE v2.5 26-Oct-2013 20:22:01

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @coatingDiattenuationVsWavelength_OpeningFcn, ...
                   'gui_OutputFcn',  @coatingDiattenuationVsWavelength_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before coatingDiattenuationVsWavelength is made visible.
function coatingDiattenuationVsWavelength_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to coatingDiattenuationVsWavelength (see VARARGIN)

% Choose default command line output for coatingDiattenuationVsWavelength
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes coatingDiattenuationVsWavelength wait for user response (see UIRESUME)
% uiwait(handles.coatingDiattenuationVsWavelength);
...
function varargout = coatingDiattenuationVsWavelength_OutputFcn(hObject, eventdata, handles) 
...
% --- Executes during object creation, after setting all properties.
function txtCoatingName_CreateFcn(hObject, ~, handles)
% hObject    handle to txtCoatingName (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
currentOpticalSystem1.SurfaceArray(surfIndex).Coating.plotCoatingDiattenuationVsWavelength(handles.axesRefVsAng,wavLen,...
