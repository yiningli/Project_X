function varargout = coatingRetardanceVsWavelength(varargin)
% COATINGRETARDANCEVSWAVELENGTH MATLAB code for coatingRetardanceVsWavelength.fig
%      COATINGRETARDANCEVSWAVELENGTH, by itself, creates a new COATINGRETARDANCEVSWAVELENGTH or raises the existing
%      singleton*.
%
%      H = COATINGRETARDANCEVSWAVELENGTH returns the handle to a new COATINGRETARDANCEVSWAVELENGTH or the handle to
%      the existing singleton*.
%
%      COATINGRETARDANCEVSWAVELENGTH('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in COATINGRETARDANCEVSWAVELENGTH.M with the given input arguments.
%
%      COATINGRETARDANCEVSWAVELENGTH('Property','Value',...) creates a new COATINGRETARDANCEVSWAVELENGTH or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before coatingRetardanceVsWavelength_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to coatingRetardanceVsWavelength_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help coatingRetardanceVsWavelength

% Last Modified by GUIDE v2.5 26-Oct-2013 21:00:07

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @coatingRetardanceVsWavelength_OpeningFcn, ...
                   'gui_OutputFcn',  @coatingRetardanceVsWavelength_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before coatingRetardanceVsWavelength is made visible.
function coatingRetardanceVsWavelength_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to coatingRetardanceVsWavelength (see VARARGIN)

% Choose default command line output for coatingRetardanceVsWavelength
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes coatingRetardanceVsWavelength wait for user response (see UIRESUME)
% uiwait(handles.coatingRetardanceVsWavelength);
...
function varargout = coatingRetardanceVsWavelength_OutputFcn(hObject, eventdata, handles) 
...
currentOpticalSystem1.SurfaceArray(surfIndex).Coating.plotCoatingRetardanceVsWavelength(handles.axesRefVsAng,wavLen,...
