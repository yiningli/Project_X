function varargout = wavefrontDiattenuationMap(varargin)
% WAVEFRONTDIATTENUATIONMAP MATLAB code for wavefrontDiattenuationMap.fig
%      WAVEFRONTDIATTENUATIONMAP, by itself, creates a new WAVEFRONTDIATTENUATIONMAP or raises the existing
%      singleton*.
%
%      H = WAVEFRONTDIATTENUATIONMAP returns the handle to a new WAVEFRONTDIATTENUATIONMAP or the handle to
%      the existing singleton*.
%
%      WAVEFRONTDIATTENUATIONMAP('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in WAVEFRONTDIATTENUATIONMAP.M with the given input arguments.
%
%      WAVEFRONTDIATTENUATIONMAP('Property','Value',...) creates a new WAVEFRONTDIATTENUATIONMAP or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before wavefrontDiattenuationMap_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to wavefrontDiattenuationMap_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help wavefrontDiattenuationMap

% Last Modified by GUIDE v2.5 26-Oct-2013 21:02:26

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @wavefrontDiattenuationMap_OpeningFcn, ...
                   'gui_OutputFcn',  @wavefrontDiattenuationMap_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before wavefrontDiattenuationMap is made visible.
function wavefrontDiattenuationMap_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to wavefrontDiattenuationMap (see VARARGIN)

% Choose default command line output for wavefrontDiattenuationMap
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes wavefrontDiattenuationMap wait for user response (see UIRESUME)
% uiwait(handles.wavefrontDiattenuationMap);
...
function varargout = wavefrontDiattenuationMap_OutputFcn(hObject, eventdata, handles) 
...
% --- Executes when panelSeetingWavefrontDiattenuationMap is resized.
function panelSeetingWavefrontDiattenuationMap_ResizeFcn(hObject, eventdata, handles)
% hObject    handle to panelSeetingWavefrontDiattenuationMap (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.panelWavefrontDiattenuationMap,'Visible','Off')
set(handles.panelSeetingWavefrontDiattenuationMap,'Visible','On')
...
set(handles.panelWavefrontDiattenuationMap,'Visible','On')
set(handles.panelSeetingWavefrontDiattenuationMap,'Visible','Off')

if ~validateOpticalSystem
%     msgbox ('The optical system is invalid.','Invalid System');
    cla(handles.axesWavefrontDiattenuation,'reset')
else
...
set(handles.output,'Visible','On');
  ...
  currentOpticalSystem2.plotWavefrontDiattenuationMap(handles.axesWavefrontDiattenuation, ...
