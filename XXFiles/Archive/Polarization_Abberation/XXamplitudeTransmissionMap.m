function varargout = amplitudeTransmissionMap(varargin)
% AMPLITUDETRANSMISSIONMAP MATLAB code for amplitudeTransmissionMap.fig
%      AMPLITUDETRANSMISSIONMAP, by itself, creates a new AMPLITUDETRANSMISSIONMAP or raises the existing
%      singleton*.
%
%      H = AMPLITUDETRANSMISSIONMAP returns the handle to a new AMPLITUDETRANSMISSIONMAP or the handle to
%      the existing singleton*.
%
%      AMPLITUDETRANSMISSIONMAP('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in AMPLITUDETRANSMISSIONMAP.M with the given input arguments.
%
%      AMPLITUDETRANSMISSIONMAP('Property','Value',...) creates a new AMPLITUDETRANSMISSIONMAP or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before amplitudeTransmissionMap_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to amplitudeTransmissionMap_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help amplitudeTransmissionMap

% Last Modified by GUIDE v2.5 26-Oct-2013 20:59:44

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @amplitudeTransmissionMap_OpeningFcn, ...
                   'gui_OutputFcn',  @amplitudeTransmissionMap_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before amplitudeTransmissionMap is made visible.
function amplitudeTransmissionMap_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to amplitudeTransmissionMap (see VARARGIN)

% Choose default command line output for amplitudeTransmissionMap
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes amplitudeTransmissionMap wait for user response (see UIRESUME)
% uiwait(handles.amplitudeTransmissionMap);
...
function varargout = amplitudeTransmissionMap_OutputFcn(hObject, eventdata, handles) 
...
% --- Executes when panelSettingAmpTransmissionMap is resized.
function panelSettingAmpTransmissionMap_ResizeFcn(hObject, eventdata, handles)
% hObject    handle to panelSettingAmpTransmissionMap (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.panelAmpTransmissionMap,'Visible','Off')
set(handles.panelSettingAmpTransmissionMap,'Visible','On')
...
set(handles.panelAmpTransmissionMap,'Visible','On')
set(handles.panelSettingAmpTransmissionMap,'Visible','Off')

if ~validateOpticalSystem
%     msgbox ('The optical system is invalid.','Invalid System');
    cla(handles.axesAmpTrans11,'reset')
else
...
set(handles.output,'Visible','On');
  ...
  currentOpticalSystem2.plotAmplitudeTransmissionMap(handles.axesAmpTrans11, ...
