function parentWindow = resetSQSEditorPanel(parentWindow) 
% resetSQSEditorPanel: reset all surface editor tables in sequence of
% surface editor.
% Member of AODParentWindow class
    ...
    set(aodHandles.tblSQSStandardData, 'Data', initialTable1);
    ...
    set(aodHandles.tblSQSApertureData , 'ColumnFormat', ...
        {'char', 'char', {'Floating' 'Circular' 'Rectangular' 'Elliptical'},...
        'char', 'numeric', 'char','numeric', 'char', 'numeric', 'char', 'numeric', 'char',...
        'numeric', 'numeric','logical'});
    set(aodHandles.tblSQSApertureData, 'Data', initialTable2,'ColumnEditable', columnEditable2,...
    ...
    initialTable5 = ...
        {'Surf',  'Standard','DxDyDzTxTyTz','',[0],'',[0],'',[0],'',[0],'',[0],'','NAX',''};
    set(aodHandles.tblSQSTiltDecenterData , 'ColumnFormat', {'char', 'char', 'char','char', 'numeric',...
        'char','numeric', 'char', 'numeric', 'char', 'numeric', 'char', 'numeric', 'char', ...
        {'DAR' 'NAX' 'BEN'},'char'});
    set(aodHandles.tblSQSTiltDecenterData, 'Data', initialTable5,'ColumnEditable', ...
