function [ lastThickness] = computeParaxialImageLocation(refIndex,thick,curv,obj_img)  
	...
	% Output
	% lastThickness: the location of the image surface from the last system surface. 
