...
drawSurface(surf1CoordinateTM,rad1,conic1,apertType1,apertParam1,...
    lensXRange1,lensYRange1,plotIn2D,axesHandle,dr,lensColor,0,gratingHeight) ;
...
for kk = 2:1:nSurf-1
    ...
    if strcmpi(medium,'None')||strcmpi(medium,'Air')||strcmpi(medium,'Mirror')
        ...
        gratingLinesPerUm = optSystem.SurfaceArray(kk).GratingLineDensity;
        
        negThick = (optSystem.SurfaceArray(kk).Thickness < 0);
        if strcmpi(medium,'Mirror')
            lensHeight(lensCounter) = drawMirror...
                (surf1CoordinateTM,rad1,conic1,apertType1,apertParam1,...
                plotIn2D,axesHandle,dr,lensColor,negThick,gratingLinesPerUm,gratingHeight);
        else            
            lensHeight(lensCounter) = drawSurface...
                (surf1CoordinateTM,rad1,conic1,apertType1,apertParam1,...
                lensXRange1,lensYRange1,plotIn2D,axesHandle,dr,lensColor,gratingLinesPerUm,gratingHeight);
        end
        ...
        apartDecX1 = apertParam1(3);
        apartDecY1 = apertParam1(4);
        gratingLinesPerUm1 = optSystem.SurfaceArray(kk).GratingLineDensity;
        
        while strcmpi(optSystem.SurfaceArray(kk+1).Type,'Dummy')
        ...
        gratingLinesPerUm2 = optSystem.SurfaceArray(kk+1).GratingLineDensity;    
        ...
        lensHeight(lensCounter) = drawLens...
            ...
            plotIn2D,axesHandle,dr,lensColor,gratingLinesPerUm1,gratingLinesPerUm2,gratingHeight);
...
lensYRange1 = [-apartSizeY1+apartDecY1,apartSizeY1+apartDecY1];
drawSurface(surf1CoordinateTM,rad1,conic1,apertType1,apertParam1,...
    lensXRange1,lensYRange1,plotIn2D,axesHandle,dr,lensColor,0) ;
hold on;
