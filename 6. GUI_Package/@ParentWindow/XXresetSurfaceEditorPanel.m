function parentWindow = resetSurfaceEditorPanel(parentWindow)
    % resetSurfaceEditorPanel: reset all surface editor tables
    ...
    initialTable1 = {'OBJECT','','Standard','',[0],'','','','','',initialData{:};...
        'STOP',  '','Standard','',[0],'','','','','',initialData{:};...
        'IMAGE', '','Standard','',[0],'','','','','',initialData{:}};
    ...
    set(aodHandles.tblStandardData, 'Data', initialTable1);
    ...
    initialTable2 = ...
        {'OBJECT','Standard','Floating','',[0],'',[0],'',[0],'',[0],'',[1],[0],false;...
        'STOP',  'Standard','Floating','',[0],'',[0],'',[0],'',[0],'',[1],[0],false;...
        'IMAGE', 'Standard','Floating','',[0],'',[0],'',[0],'',[0],'',[1],[0],false};
    set(aodHandles.tblApertureData , 'ColumnFormat', ...
        {'char', 'char', {'Floating' 'Circular' 'Rectangular' 'Elliptical'},...
        'char', 'numeric', 'char','numeric', 'char', 'numeric', 'char', 'numeric', 'char',...
        'numeric', 'numeric','logical'});
    set(aodHandles.tblApertureData, 'Data', initialTable2,'ColumnEditable', columnEditable2,...
    ...
    initialTable5 = ...
        {'OBJECT','Standard','DxDyDzTxTyTz','',[0],'',[0],'',[0],'',[0],'',[0],'','DAR','';...
        'STOP',  'Standard','DxDyDzTxTyTz','',[0],'',[0],'',[0],'',[0],'',[0],'','DAR','';...
        'IMAGE', 'Standard','DxDyDzTxTyTz','',[0],'',[0],'',[0],'',[0],'',[0],'','DAR',''};
    set(aodHandles.tblTiltDecenterData , 'ColumnFormat', {'char', 'char', 'char','char', 'numeric',...
        'char','numeric', 'char', 'numeric', 'char', 'numeric', 'char', 'numeric', 'char', ...
        {'DAR' 'NAX' 'BEN'},'char'});
    set(aodHandles.tblTiltDecenterData, 'Data', initialTable5,'ColumnEditable', ...
