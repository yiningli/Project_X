function [ generalPulsedBeam, spatialDistribution, spectralDistribution ] = ...
    convertToGeneralPulsedBeam( gaussianPulsedBeam,nWavSampling,nXYSampling )
...
generalPulsedBeam = GeneralPulsedBeam(planeWaveArray,direction);
