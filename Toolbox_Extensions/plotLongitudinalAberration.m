...
if ~(isempty(wavIndices_nRay)||...
    ...
    nWavelength = opticalSystem.getNumberOfWavelengths;
...
endSurface = opticalSystem.getNumberOfSurfaces;
[tangentialRayTracerResult] = opticalSystem.multipleRayTracer(wavLen,...
    fieldPointXY,1,nRay,PupSamplingType,considerPolarization,...
...
surfIndex = opticalSystem.getNumberOfSurfaces;
fieldIndex = 1;
figure;
for wavIndex = 1:nWav
    ...
    tangentialFanFinalDirections = ...
        [tangentialRayTracerResult(rayTraceResultIndexOfLastSurface,:,fieldIndex,wavIndex).IncidentRayDirection];
